...
fun main(args: Array<String>) {
    ...
    driver(DriverParameters(startNodesInProcess = true, extraCordappPackagesToScan = listOf("net.corda.examples.attachments"),waitForAllNodesToFinish = true,isDebug = true)) {
